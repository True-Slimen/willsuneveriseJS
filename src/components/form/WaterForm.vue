...
<template>
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input id="octave" type="range" min="0.005" max="0.04" step="0.001" v-model="paramsNoise.scale" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
    </div>
    ...
    <label class="text-sm font-medium text-slate-400">
      <input type="checkbox" v-model="paramsNoise.invert" class="mr-2">
      Inverser la noise
    </label>

    <div class="input-group">
      <label for="dirt-threshold" class="block text-sm font-medium text-slate-400">
        Seuil Dirt : {{ paramsNoise.threshold }}
      </label>
      <input
          id="dirt-threshold"
          type="range"
